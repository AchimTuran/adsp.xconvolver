...
ADSP_POSTMOD_UNIQUEDBID adspPostUniqueDbId[ADSP_MAX_POST_MODES] = {-1, -1};
ADSP_POSTMOD_STR_NAMES adspPostStrNames[ADSP_MAX_POST_MODES][AE_DSP_ADDON_STRING_LENGTH] = {"Convolver", "Channel Mixer"};
...
ADSP_POSTMOD_NAME adspPostName[ADSP_MAX_POST_MODES] = { 30000, 30003 };
ADSP_POSTMOD_SETUP_NAME adspPostSetupName[ADSP_MAX_POST_MODES] = { 30001, 30004 };
ADSP_POSTMOD_DESCRIPTION adspPostDescription[ADSP_MAX_POST_MODES] = { 30002, 30005 };
ADSP_POSTMOD_HELP adspPostHelp[ADSP_MAX_POST_MODES] = { 30100, 30101 };

ADSP_POSTMOD_OWN_IMAGE adspPostOwnImage[ADSP_MAX_POST_MODES][AE_DSP_ADDON_STRING_LENGTH] = { "img1.jpg", "img1.jpg" };
