...
ADSP_POSTMOD_STR_NAMES adspPostStrNames[ADSP_MAX_POST_MODES][AE_DSP_ADDON_STRING_LENGTH] = {"FIR-Convolver"};
...
ADSP_POSTMOD_HELP adspPostHelp[ADSP_MAX_POST_MODES] = {30100};
